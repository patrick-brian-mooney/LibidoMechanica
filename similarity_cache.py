...
import array, bz2, functools, glob, os, pickle, time
...
class BasicSimilarityCache(object):
    ...
    (new) BasicSimilarityCache. It is no longer used, but its code remains in case files
